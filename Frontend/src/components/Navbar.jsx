...
function Navbar() {
    ...
    return (
      ...
      <nav className={navbar ? 'navbar fixed-top navbar-expand-lg navbar-dark p-md-3 text-end ' : 'navbar fixed-top navbar-expand-lg navbar-dark p-md-3 bg-dark shadow text-end '}>
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navcol-11">
            <ul className="navbar-nav rightAlign">
